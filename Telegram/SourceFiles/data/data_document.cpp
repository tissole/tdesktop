...
bool DocumentData::isVideo() const {
...
//               || _filename.endsWith(u".asf"_q, Qt::CaseInsensitive)
               ...
               || _filename.endsWith(u".aac"_q, Qt::CaseInsensitive)
               || _filename.endsWith(u".ac3"_q, Qt::CaseInsensitive)
               || _filename.endsWith(u".dts"_q, Qt::CaseInsensitive)
               || _filename.endsWith(u".dtshd"_q, Qt::CaseInsensitive)
               || _filename.endsWith(u".f4a"_q, Qt::CaseInsensitive)
               || _filename.endsWith(u".f4b"_q, Qt::CaseInsensitive)
